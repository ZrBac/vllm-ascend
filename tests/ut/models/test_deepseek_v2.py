...
from vllm_ascend.models.deepseek_v2 import (
    CustomDeepseekV2SiluAndMul, CustomDeepseekV2MergedReplicatedLinear,
    CustomDeepseekV2RowParallelLinearReplaceAllreduce,
    CustomDeepseekV2RowParallelLinear, CustomDeepseekV2MLP,
    CustomDeepseekV2MoE, CustomDeepseekV2MLAAttention,
    CustomDeepseekV2DecoderLayer, CustomDeepseekV2Model,
